...
/**
 * @author 11718
 * on 2017  December 03 Sunday 11:54.
 */
...
public class AutoRollTextView extends TextSwitcher implements ViewSwitcher.ViewFactory
{
	...
	public AutoRollTextView(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		// TODO Auto-generated constructor stub
		TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.AppCompatTheme);
	...
	private Rotate3dAnimation createAnim(float start, float end, boolean turnIn,
			boolean turnUp)
	{
